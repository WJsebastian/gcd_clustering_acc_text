...
from dataset_with_pca_1k import cluster_dataset
from os import path
...
if __name__ == "__main__":
    ...
    parser.add_argument('--K', default=1000, type=int, help='Set manually to run with custom K')
    ...
    parser.add_argument('--dataset_root', type=str, default='/home/cliu/datasets/imagenet_1k/')
